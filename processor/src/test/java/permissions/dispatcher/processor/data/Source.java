    ...
    public static final BaseTest OnePermissionActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "       if (PermissionUtils.hasSelfPermissions(target, true, PERMISSION_SHOWCAMERA)) {",
                    "           target.showCamera();",
                    "       } else {",
    ...
    public static final BaseTest OnePermissionSupportFragment = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "       if (PermissionUtils.hasSelfPermissions(target.requireActivity(), true, PERMISSION_SHOWCAMERA)) {",
                    "           target.showCamera();",
                    "       } else {",
    ...
    public static final BaseTest TwoPermissionsWithNeverAskActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "       if (PermissionUtils.hasSelfPermissions(target, true, PERMISSION_ACCESSCONTACTS)) {",
    ...
    public static final BaseTest TwoPermissionsFragment = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "       if (PermissionUtils.hasSelfPermissions(target.requireActivity(), true, PERMISSION_ACCESSCONTACTS)) {",
                    "           target.accessContacts();",
                    "       } else {",
    ...
    public static final BaseTest TwoPermissionsWithSameSignatureActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "       if (PermissionUtils.hasSelfPermissions(target, true, PERMISSION_SHOWCAMERA2)) {",
                    "           target.showCamera2();",
                    "       } else {",
    ...
    public static final BaseTest TwoPermissionsWithSameSignatureFragment = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "       if (PermissionUtils.hasSelfPermissions(target.requireActivity(), true, PERMISSION_SHOWCAMERA2)) {",
                    "           target.showCamera2();",
                    "       } else {",
    ...
    public static final BaseTest NoDuplicatesDespiteRepeatedValuesActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "       if (PermissionUtils.hasSelfPermissions(target, true, PERMISSION_SHOWGETSTORAGE)) {",
    ...
    public static final BaseTest WriteSettingsFragment = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "    if (PermissionUtils.hasSelfPermissions(target.requireActivity(), true, PERMISSION_WRITESETTINGS) || Settings.System.canWrite(target.requireActivity())) {",
    ...
    public static final BaseTest SystemAlertWindowFragment = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "    if (PermissionUtils.hasSelfPermissions(target.requireActivity(), true, PERMISSION_SYSTEMALERTWINDOW) || Settings.canDrawOverlays(target.requireActivity())) {",
    ...
    public static final BaseTest WriteSettingsActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "    if (PermissionUtils.hasSelfPermissions(target, true, PERMISSION_WRITESETTINGS) || Settings.System.canWrite(target)) {",
                    "      target.writeSettings();",
                    "    } else {",
                    "      if (PermissionUtils.shouldShowRequestPermissionRationale(target, PERMISSION_WRITESETTINGS)) {",
    ...
    public static final BaseTest SystemAlertWindowActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "    if (PermissionUtils.hasSelfPermissions(target, true, PERMISSION_SYSTEMALERTWINDOW) || Settings.canDrawOverlays(target)) {",
                    "      target.systemAlertWindow();",
                    "    } else {",
                    "      if (PermissionUtils.shouldShowRequestPermissionRationale(target, PERMISSION_SYSTEMALERTWINDOW)) {",
